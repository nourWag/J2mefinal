...
public class SplashScreen extends Canvas implements Runnable {
     ...
     */
    public SplashScreen(Midlet2 projectMIDlet) {
        this.projectMIDlet = projectMIDlet;
        try {
            mImage = Image.createImage("/tu.jpg");
    ...
    public void paint(Graphics g) {
        ...
        g.drawImage(mImage, width, height/2 ,
    ...
    public void dismiss() {
        if (isShown()) {
            Display.getDisplay(projectMIDlet).setCurrent(new Login1Form());
        }
